...
function HomeContent(): JSX.Element {
  return (
    <>
      <div className="img__wrap w-7/12 p-10">
        <img alt={"pong"} src={Pong} />
      </div>
      <div className="content__wrap flex flex-col justify-center w-5/12 p-10">
        <div className="text__wrap flex justify-center p-10">
          <h1 className="text-3xl font-semibold w-[300px] h-[40px] text-center font-main">
            퐁게임 함 하쉴???
          </h1>
        </div>
        <div className="empty p-10"></div>
        <ButtonOne
          tag={"로 그 인"}
          onClick={() =>
